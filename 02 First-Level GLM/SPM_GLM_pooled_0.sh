...
#SBATCH --job-name=glm_pooled_0    # The job name.
...
module load matlab
matlab -nodisplay -nosplash - nodesktop -r "cd /moto/home/ak4572/; try, run ('/moto/home/ak4572/first_level_0_pooled_moto.m'); catch me, fprintf('%s / %s\n',me.identifier,me.message), end, exit"
