...
Opts.delete_estimates = true; % will delete estimates betas and residues if inference is pooled
...
%             spm_specify.matlabbatch{1}.spm.stats.fmri_spec.sess(r).regress = {''};
    ...
    spm_contrasts = {};
    spm_contrasts.matlabbatch{1}.spm.stats.con.spmmat = {[Dirs.subject_results_dir filesep 'SPM.mat']}; 
    spm_contrasts.matlabbatch{1}.spm.stats.con.consess{1}.fcon.name = 'Effects-of-interest';
    spm_contrasts.matlabbatch{1}.spm.stats.con.consess{1}.fcon.weights = effects_of_interest_multi(Opts, r); 
    ...
    spm_results = {};
    spm_results.matlabbatch{1}.spm.stats.results.spmmat = {[Dirs.subject_results_dir filesep 'SPM.mat']}; 
...
%             spm_results.matlabbatch{1}.spm.stats.results.conspec.mask.image.mtype = 0;
    ...
    better_results_table(Dirs.subject_results_dir, spm_results, TabDat);

    % Save cluster map and significance map as nifti file
    make_inferential_maps(Dirs.subject_results_dir);
