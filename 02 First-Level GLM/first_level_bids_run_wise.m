...
Opts.unique_conditions_to_include = logical(ones(50,1)); % after sorting the unique conditions in your events file, this logical vector filters out unwanted conditions; set this to logical(ones(number_of_unique_conditions, 1)) if you want to include all
