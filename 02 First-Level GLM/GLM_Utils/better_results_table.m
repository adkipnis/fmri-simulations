...
%     n_reg = size(SPM.xX.X,2);
    ...
    for i=1:n_con
        ...
        table_path =  [results_dir,'/TabDat_',con_title{i},'.csv']; 
        footer_path =  [results_dir,'/TabDat_',con_title{i},'_footer.txt']; 
