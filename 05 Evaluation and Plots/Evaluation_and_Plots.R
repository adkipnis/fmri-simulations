...
df$GT = ordered(as.factor(df$GT), levels = c("V1_left_mean", "V1_right_mean",
                                             "V2_left_mean", "V2_right_mean",
                                             "V3_left_mean", "V3_right_mean",
                                             "V4_left_mean", "V4_right_mean",
                                             "VVC_left_mean", "VVC_right_mean",
                                             "VMV_left_mean", "VMV_right_mean",
                                             "PHA_left_mean", "PHA_right_mean",
                                             "FFC_left_mean", "FFC_right_mean",
                                             "IT_left_mean", "IT_right_mean",
                                             "MT+MST_left_mean", "MT+MST_right_mean"))
df$GT[which(is.na(df$GT))] = "MT+MST_right_mean" 
df$GT = recode(df$GT, "V1_left_mean" = "V1-left",
               "V1_right_mean" = "V1-right",
               "V2_left_mean" = "V2-left",
               "V2_right_mean" = "V2-right",
               "V3_left_mean" = "V3-left",
               "V3_right_mean" = "V3-right",
               "V4_left_mean" = "V4-left",
               "V4_right_mean" = "V4-right",
               "VVC_left_mean" = "VVC-left",
               "VVC_right_mean" = "VVC-right",
               "VMV_left_mean" = "VMV-left",
               "VMV_right_mean" = "VMV-right",
               "PHA_left_mean" = "PHA-left",
               "PHA_right_mean" = "PHA-right",
               "FFC_left_mean" = "FFC-left",
               "FFC_right_mean" = "FFC-right",
               "IT_left_mean" = "IT-left",
               "IT_right_mean" = "IT-right",
               "MT+MST_left_mean" = "MT/MST-left",
               "MT+MST_right_mean" = "MT/MST-right")
df$pattern_subset = as.factor(df$pattern_subset)
df$pattern_subset_type = recode(df$pattern_subset_type,
                                "random" = "randomly sampled conditions",
                                "serial" = "orderly* sampled conditions")
